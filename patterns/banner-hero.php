...
<div class="wp-block-cover alignfull is-light has-custom-content-position is-position-center bhero-backgroundImage" style="min-height:80vh"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-30 has-background-dim"></span>
    <div class="wp-block-cover__inner-container">
        ...
        <!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"72px"}},"className":"has-text-align-center"} -->
        <h1 class="wp-block-heading has-text-align-center" style="font-size:72px">
            Alcanza tus objetivos Financieros </h1>
        <!-- /wp:heading -->

        <!-- wp:heading {"style":{"typography":{"fontStyle":"normal","fontWeight":"400","fontSize":"24px"}},"className":"has-text-align-center", "level":3} -->
        <h3 class="wp-block-heading has-text-align-center" style="font-size:24px;font-style:normal;font-weight:400">
            Contabilidad, Consultoría y Auditoría especializada </h3>
        <!-- /wp:heading -->
